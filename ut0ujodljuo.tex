\begin{table}
\caption{Approximate Dimensions of the HT PCHE Recuperator installed in test loop at Sandia National Laboratories \citep{Pasch2012}} \label{tab:Approximate}
\begin{center}
